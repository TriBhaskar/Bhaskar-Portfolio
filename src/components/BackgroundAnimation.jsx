export default function BackgroundAnimation() {
  return (
    <div className="background-animation absolute lg:block lg:top-80 lg:left-0 lg:w-4/5 lg:h-3/5 -z-10 pointer-events-none md:top-20 md:right-14 md:w-2/5 md:block hidden">
      <svg
        className="BgAnimation__svg lg:w-full lg:h-full md:w-3/4 md:h-3/4 sm:w-2/3 sm:h-2/3"
        viewBox="0 0 602 602"
        fill="none"
