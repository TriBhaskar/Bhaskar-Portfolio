    ...
    >
      <li className="mr-5 text-xs shrink-0">
        <a
          ...
          href="https://github.com/TriBhaskar"
          target="_blank"
      ...
      <li className="mr-5 text-xs shrink-0">
        <a
          className="block hover:text-slate-200"
          href="https://www.linkedin.com/in/bhaskar-panthri-67581b177/"
          target="_blank"
          rel="noreferrer noopener"
      ...
      <li className="mr-5 text-xs shrink-0">
        <a
          className="block hover:text-slate-200"
          href="https://www.hackerrank.com/profile/panthribhaskar"
          target="_blank"
          rel="noreferrer noopener"
          aria-label="HackerRank (opens in a new tab)"
          title="HackerRank"
        >
